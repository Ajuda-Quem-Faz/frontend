...
function UpdateProfile() {
    ...
    return (
        ...
        <div className="flex flex-col items-center mt-4">
            ...
            <form action="" className="flex flex-col gap-2 pt-4 w-2/3" onSubmit={atualizarUsuario}>
                ...
                <input type="text" placeholder="Insira URL da foto"
                    className="border-2 rounded-lg text-base font-normal text-dark-black px-2 py-1"
                    name="foto"
                    id="foto"
                ...
                <textarea rows={5} className="border-2 rounded-lg text-base font-normal text-dark-black px-2 py-1"
                    name="sobre"
                    id="sobre"
