function Contact() {
  return (
    <>
      <div id='container-contact' className='grid grid-cols-2 w-5/6 mx-auto my-10 rounded-3xl bg-orange-500'>
        ...
        <div className='w-full p-4 m-6'>
          ...
          <div className='grid grid-cols-2'>
            ...
            <div>
              ...
              <button type='submit' className='rounded-xl bg-white hover:bg-zinc-300
              w-3/4 h-10 py-2 my-4 flex justify-center items-center'>Sou vendedor</button>
            </div>
            {/* Container Problemas */}
            <div>
              <button type='submit' className='rounded-xl bg-white hover:bg-zinc-300
              ...
              <button type='submit' className='rounded-xl bg-white hover:bg-zinc-300
              w-3/4 h-10 py-2 my-4 flex justify-center items-center'>Problemas com produto</button>
              <button type='submit' className='rounded-xl bg-white hover:bg-zinc-300
              w-3/4 h-10 py-2 my-4 flex justify-center items-center'>Problemas com frete</button>
            </div>
          </div>
