    ...
    <>
      ...
      <div className='bg-violet-800 w-full p-2 flex'>
        <div>
          ...
          <p className='text-white'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Assumenda expedita amet asperiores ipsum neque excepturi. Labore quod asperiores reprehenderit, facere quaerat amet quam illum libero dolorum vel corporis pariatur magnam.</p>
        </div>
        <div>
          <img src='https://static.thenounproject.com/png/526867-200.png'></img>
        </div>
