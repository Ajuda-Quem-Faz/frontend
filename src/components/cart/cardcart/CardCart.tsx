...
function CardCart({ item }: CardProdutosProps) {
  ...
  const ConfirmacaoRemoverProduto: React.FC<{ onConfirm: () => void }> = ({
    ...
    return (
      <div className="">
        <p className="mb-4 text-lg">Tem certeza que deseja remover este item?</p>
  ...
  return (
    // Card do Produto
    <div>
      <div className="flex flex-col rounded-xl overflow-hidden justify-between bg-tertiary-blueLight">
        ...
        <div className="flex items-center">
          ...
          <img src={item.foto} className="w-1/3 h-auto" alt={item.nome} />
      ...
      {item.preco ? (
        <div className="flex justify-center items-center">
          <div className="grid grid-cols-3 w-full justify-center items-center bg-light-gray rounded-2xl mt-1">
            <button
              onClick={incrementar}
              className="text-white bg-green-500 hover:bg-green-600 font-bold text-xl rounded-s-lg flex-shrink-0"
            >
              +
            </button>
            <p className="text-xl flex items-center justify-center">{quantidade}</p>
            <button
              onClick={decrementar}
              className=" text-white bg-red-500 hover:bg-red-600 font-bold text-xl rounded-e-lg flex-shrink-0"
            >
              -
            </button>
          </div>
        ...
        <button
          onClick={decrementar}
          className=" text-white bg-red-500 hover:bg-red-600 font-bold mt-1 py-1 px-5 rounded-lg w-full "
        >
          Remover
        </button>
      )}
