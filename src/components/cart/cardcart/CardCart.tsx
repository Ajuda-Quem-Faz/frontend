...
function CardCart({ item }: CardProdutosProps) {
    ...
    const ConfirmacaoRemoverProduto: React.FC<{ onConfirm: () => void }> = ({ onConfirm }) => {
            ...
            <div className="p-4 bg-white rounded-lg shadow-md">
                ...
                <div className="flex justify-between">
                    ...
                    <button
                        ...
                        onClick={() => {toast.dismiss(); setNotificacaoExibida(false);} }
                    >
                        Cancelar
                    </button>
                </div>
    ...
    const handleRemoverProduto = (id: number) => {
        if (!notificacaoExibida) {
            toast(<ConfirmacaoRemoverProduto onConfirm={() => {
                removerProduto(id);
    ...
    return (
        ...
        <div className='flex flex-col rounded-lg overflow-hidden justify-between bg-tertiary-blueLight'>
            ...
            <div className='py-4'>
                ...
                <img src={item.foto} className='mt-1 h-40 max-w-75 mx-auto rounded-lg' alt={item.nome} />
                ...
                <div className='p-4'>
                    ...
                    <div className="flex justify-center items-center p-1">
                        ...
                        <div className="flex justify-items-end items-center">
                            <button onClick={incrementar} className="text-white bg-green-500 hover:bg-green-600 font-bold text-2xl w-8 h-8 rounded-lg mx-2 flex-shrink-0">+</button>
                            <p className="text-2xl w-6 h-12 flex items-center justify-center">{quantidade}</p>
                            <button onClick={decrementar} className=" text-white bg-red-500 hover:bg-red-600 font-bold text-2xl w-8 h-8 rounded-lg mx-2 flex-shrink-0">-</button>
                        </div>
                    </div>
                </div>
            </div>
